#include "InteractuableCarrot.h"
#include "../Logic/Game.h"

InteractuableCarrot::InteractuableCarrot(Game* game, int x, int y, int w, int h) : GameObject(game, true), rewardT_(nullptr)
{	
...
void InteractuableCarrot::onPlayerInteraction(Player* player)
{
	if (active) {
...
void InteractuableCarrot::selectReward(int reward, Player* player)
{
